...
#
# Created: Fri Aug 19 11:31:49 2016
...
class Ui_Dialog_Config(object):
    def setupUi(self, Dialog_Config):
        ...
        self.gridLayout_6.addWidget(self.lineEdit_host_write, 31, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_username_write, 31, 3, 1, 2)
        self.lineEdit_pass_write = QtGui.QLineEdit(self.tab_3)
        self.lineEdit_pass_write.setObjectName(_fromUtf8("lineEdit_pass_write"))
        self.gridLayout_6.addWidget(self.lineEdit_pass_write, 31, 5, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_database_write, 33, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_port_write, 33, 2, 1, 1)
        ...
        self.comboBox_server_write.setMinimumSize(QtCore.QSize(20, 0))
        self.comboBox_server_write.setObjectName(_fromUtf8("comboBox_server_write"))
        self.comboBox_server_write.addItem(_fromUtf8(""))
        self.comboBox_server_write.addItem(_fromUtf8(""))
        self.gridLayout_6.addWidget(self.comboBox_server_write, 29, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog_Config):
        ...
        self.comboBox_server_read.setItemText(0, _translate("Dialog_Config", "sqlite", None))
        self.comboBox_server_read.setItemText(1, _translate("Dialog_Config", "postgres", None))
        ...
        self.comboBox_server_write.setItemText(0, _translate("Dialog_Config", "postgres", None))
        self.comboBox_server_write.setItemText(1, _translate("Dialog_Config", "sqlite", None))
