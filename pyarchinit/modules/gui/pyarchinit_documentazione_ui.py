...
#
# Created: Fri Oct 17 14:39:05 2014
...
class Ui_DialogDocumentazione_tipo_doc(object):
    def setupUi(self, DialogDocumentazione_tipo_doc):
        ...
        DialogDocumentazione_tipo_doc.resize(548, 523)
        ...
        self.comboBox_sito_doc.setEnabled(True)
        ...
        self.comboBox_sito_doc.setEditable(False)
        ...
        self.lineEdit_nome_doc.setEnabled(True)
        self.lineEdit_nome_doc.setObjectName(_fromUtf8("lineEdit_nome_doc"))
        self.gridLayout_7.addWidget(self.lineEdit_nome_doc, 4, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_2_sorgente_doc, 4, 2, 1, 1)
        ...
        self.comboBox_scala_doc.addItem(_fromUtf8(""))
        self.comboBox_scala_doc.addItem(_fromUtf8(""))
        self.gridLayout_6.addWidget(self.comboBox_scala_doc, 5, 2, 1, 1)
        self.label_2_scala_doc = QtGui.QLabel(self.tab_1_doc)
        self.label_2_scala_doc.setObjectName(_fromUtf8("label_2_scala_doc"))
        self.gridLayout_6.addWidget(self.label_2_scala_doc, 6, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_disegnatore_doc, 7, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_2_disegnatore_doc, 8, 2, 1, 1)
        self.comboBox_tipo_doc = QtGui.QComboBox(self.tab_1_doc)
        ...
        self.comboBox_tipo_doc.addItem(_fromUtf8(""))
        self.comboBox_tipo_doc.addItem(_fromUtf8(""))
        self.gridLayout_6.addWidget(self.comboBox_tipo_doc, 1, 2, 1, 1)
        self.label_2_tipo_doc = QtGui.QLabel(self.tab_1_doc)
        self.label_2_tipo_doc.setObjectName(_fromUtf8("label_2_tipo_doc"))
        self.gridLayout_6.addWidget(self.label_2_tipo_doc, 2, 2, 1, 1)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_6.addItem(spacerItem, 12, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.tabWidget_tab_doc, 6, 0, 1, 1)
    ...
    def retranslateUi(self, DialogDocumentazione_tipo_doc):
        DialogDocumentazione_tipo_doc.setWindowTitle(QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "pyArchInit Gestione Scavi - Scheda Campioni", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_tipo_doc.setItemText(0, QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "Pianta", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_doc.setItemText(1, QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "Sezione", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_sorgente_doc.setItemText(0, QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "Lucido", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_sorgente_doc.setItemText(1, QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "Foto", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_sorgente_doc.setItemText(2, QtGui.QApplication.translate("DialogDocumentazione_tipo_doc", "Rilievo diretto (tablet)", None, QtGui.QApplication.UnicodeUTF8))
