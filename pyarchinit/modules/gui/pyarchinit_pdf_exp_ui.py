...
#
# Created: Tue Apr 29 16:59:42 2014
...
class Ui_Dialog_pdf_exp(object):
    def setupUi(self, Dialog_pdf_exp):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/pdf-icon.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_exp_pdf.setIcon(icon1)
        self.pushButton_exp_pdf.setObjectName(_fromUtf8("pushButton_exp_pdf"))
        self.gridLayout_2.addWidget(self.pushButton_exp_pdf, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_sito, 1, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.checkBox_US, 2, 2, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconStrutt.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_struttura.setIcon(icon3)
        ...
        self.gridLayout.addWidget(self.checkBox_struttura, 3, 2, 1, 1)
        self.checkBox_individui = QtGui.QCheckBox(self.tab)
        self.checkBox_individui.setText(_fromUtf8(""))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconIND.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_individui.setIcon(icon4)
        self.checkBox_individui.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_individui.setObjectName(_fromUtf8("checkBox_individui"))
        self.gridLayout.addWidget(self.checkBox_individui, 3, 3, 1, 1)
        ...
        self.checkBox_periodo.setIcon(icon5)
        self.checkBox_periodo.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_periodo.setObjectName(_fromUtf8("checkBox_periodo"))
        self.gridLayout.addWidget(self.checkBox_periodo, 3, 1, 1, 1)
        self.checkBox_reperti = QtGui.QCheckBox(self.tab)
        self.checkBox_reperti.setText(_fromUtf8(""))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/finds.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_reperti.setIcon(icon6)
        self.checkBox_reperti.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_reperti.setObjectName(_fromUtf8("checkBox_reperti"))
        self.gridLayout.addWidget(self.checkBox_reperti, 3, 0, 1, 1)
        self.checkBox_tafonomia = QtGui.QCheckBox(self.tab)
        self.checkBox_tafonomia.setText(_fromUtf8(""))
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconGrave.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_tafonomia.setIcon(icon7)
        ...
        self.gridLayout.addWidget(self.checkBox_tafonomia, 4, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_open_dir, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog_pdf_exp):
        ...
        self.pushButton_open_dir.setText(QtGui.QApplication.translate("Dialog_pdf_exp", "open dir", None, QtGui.QApplication.UnicodeUTF8))
