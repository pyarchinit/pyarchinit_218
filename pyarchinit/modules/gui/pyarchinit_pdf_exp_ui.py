...
#
# Created: Mon Apr 28 19:47:46 2014
...
class Ui_Dialog_pdf_exp(object):
    def setupUi(self, Dialog_pdf_exp):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconPAI.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_US.setIcon(icon1)
        self.checkBox_US.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_US.setObjectName(_fromUtf8("checkBox_US"))
        self.gridLayout.addWidget(self.checkBox_US, 1, 0, 1, 1)
        self.checkBox_struttura = QtGui.QCheckBox(self.tab)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconStrutt.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_struttura.setIcon(icon2)
        self.checkBox_struttura.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_struttura.setObjectName(_fromUtf8("checkBox_struttura"))
        self.gridLayout.addWidget(self.checkBox_struttura, 1, 1, 1, 1)
        self.checkBox_periodo = QtGui.QCheckBox(self.tab)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconPER.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_periodo.setIcon(icon3)
        self.checkBox_periodo.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_periodo.setObjectName(_fromUtf8("checkBox_periodo"))
        self.gridLayout.addWidget(self.checkBox_periodo, 1, 2, 1, 1)
        self.checkBox_reperti = QtGui.QCheckBox(self.tab)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/finds.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_reperti.setIcon(icon4)
        self.checkBox_reperti.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_reperti.setObjectName(_fromUtf8("checkBox_reperti"))
        self.gridLayout.addWidget(self.checkBox_reperti, 2, 0, 1, 1)
        self.checkBox_tafonomia = QtGui.QCheckBox(self.tab)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconGrave.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_tafonomia.setIcon(icon5)
        ...
        self.gridLayout.addWidget(self.checkBox_tafonomia, 3, 0, 1, 1)
        self.checkBox_individui = QtGui.QCheckBox(self.tab)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/iconIND.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.checkBox_individui.setIcon(icon6)
        self.checkBox_individui.setIconSize(QtCore.QSize(30, 30))
        self.checkBox_individui.setObjectName(_fromUtf8("checkBox_individui"))
        self.gridLayout.addWidget(self.checkBox_individui, 4, 0, 1, 1)
        self.pushButton_exp_pdf = QtGui.QPushButton(self.tab)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/pdf-icon.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_exp_pdf.setIcon(icon7)
        self.pushButton_exp_pdf.setObjectName(_fromUtf8("pushButton_exp_pdf"))
        self.gridLayout.addWidget(self.pushButton_exp_pdf, 4, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog_pdf_exp):
        ...
        self.checkBox_tafonomia.setText(QtGui.QApplication.translate("Dialog_pdf_exp", "Tafonomia", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_individui.setText(QtGui.QApplication.translate("Dialog_pdf_exp", "Individui", None, QtGui.QApplication.UnicodeUTF8))
