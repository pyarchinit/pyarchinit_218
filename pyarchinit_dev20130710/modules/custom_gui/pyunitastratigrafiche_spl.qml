...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="245,108,113,255"/>
  ...
  <attributeEditorForm>
    <attributeEditorContainer name="Dati ID US">
      <attributeEditorField index="0" name="id"/>
      <attributeEditorField index="2" name="scavo_s"/>
      <attributeEditorField index="1" name="area_s"/>
      <attributeEditorField index="3" name="us_s"/>
      <attributeEditorField index="4" name="stratigraph_index_us"/>
      <attributeEditorField index="5" name="tipo_us_s"/>
    </attributeEditorContainer>
    <attributeEditorContainer name="Dati rilievo originale">
      <attributeEditorField index="6" name="rilievo_orginale"/>
      <attributeEditorField index="7" name="disegnatore"/>
      <attributeEditorField index="8" name="data"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <attributeactions/>
</qgis>
