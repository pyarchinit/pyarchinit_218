...
#
# Created: Thu Jan 23 16:06:24 2014
...
class Ui_DialogThesaurus(object):
    def setupUi(self, DialogThesaurus):
        ...
        DialogThesaurus.resize(589, 522)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/4_leftArrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_prev_rec.setIcon(icon10)
        self.pushButton_prev_rec.setObjectName(_fromUtf8("pushButton_prev_rec"))
        self.gridLayout.addWidget(self.pushButton_prev_rec, 0, 4, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.comboBox_sigla, 2, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.comboBox_sigla_estesa, 2, 1, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.comboBox_tipologia_sigla, 4, 0, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.comboBox_nome_tabella, 4, 2, 1, 1)
        ...
        self.gridLayout_6.addLayout(self.verticalLayout_3, 6, 0, 1, 3)
    ...
    def retranslateUi(self, DialogThesaurus):
        ...
        self.pushButton_connect.setText(QtGui.QApplication.translate("DialogThesaurus", "Reload DB", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_tipologia_sigla.setItemText(0, QtGui.QApplication.translate("DialogThesaurus", "Inserisci un valore", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_nome_tabella.setItemText(0, QtGui.QApplication.translate("DialogThesaurus", "Inserisci un valore", None, QtGui.QApplication.UnicodeUTF8))
