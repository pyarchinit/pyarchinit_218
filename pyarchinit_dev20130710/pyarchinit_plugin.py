...
class PyArchInitPlugin:
	...
	def initGui(self):
		...
		self.actionThesaurus = QAction(QIcon(icon_thesaurus), "pyArchInit Scheda Thesaurus Sigle", self.iface.mainWindow())
		self.actionThesaurus.setWhatsThis("pyArchInit Scheda Thesaurus Sigle")
